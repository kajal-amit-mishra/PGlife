...
<body>
    ...
    <!-- <script>
        // Your JavaScript code to handle the AJAX response
        // ...

        // Example:
        // Assuming "response" is the variable containing the JSON response
        var responseClass = response.class;
        var messageContainer = document.getElementById("message-container"); // Adjust this based on your HTML structure
